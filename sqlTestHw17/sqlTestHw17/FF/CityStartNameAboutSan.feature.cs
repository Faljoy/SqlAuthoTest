...
namespace sqlTestHw17.FF
{
    ...
    [NUnit.Framework.DescriptionAttribute("CheckCityWhereNameLikeSan...")]
    public partial class CheckCityWhereNameLikeSan_Feature
    {
...
#line 1 "CityStartNameAboutSan.feature"
#line hidden
        ...
        public virtual void ScenarioAboutSearchCityWhereNameLikeSan()
        {
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 8
 testRunner.When("i chose in table \"Persons\" all results, where name of city like \"San\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 9
 testRunner.Then("i see city which start with \"San\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
